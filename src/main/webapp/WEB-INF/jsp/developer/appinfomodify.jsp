...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal form-label-left" action="appinfomodifysave.html" method="post"
                  ...
                  ${appInfo.appInfo}</textarea>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="hidden" id="logoLocPath" name="logoLocPath"
                                   value="${pageContext.request.contextPath }/${appInfo.logoPicPath }"/>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <button id="send" type="submit" name="status" value="0" class="btn btn-success">保存</button>
